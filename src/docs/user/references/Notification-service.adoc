...
All users are able to create channels for any group. It is needed to provide a unique channel name and a list of groups
...
it's severity and the notified channels which are provided as a comma separated list.
